<template>
  <div>
    <div
      class="relative overflow-hidden full-height"
      style="padding: 70px 0;">
      <div class="parallax"><img
        class="responsive-img"
        src="img/hyperloop/hyperloop.jpg"
        alt="Hyperloop sketch"></div>
      <div class="container center">
        <div class="title-box">
          <h1
            class="subtitle white">Hyperl<span>o</span><span style="margin-left:-1.1%;">o</span>p</h1>
        </div>
      </div>
    </div>
    <div class="section white">
      <div class="container row">
        <h2
          class="subtitle"
          style="font-size: 7vmin;">What is Hyperloop?</h2>
        <p
          class="subtitle-text"
          style="color:#808080;">The Hyperloop is a proposed supersonic train line stretching across the country in underground airless tubes. We believe that it's the future of transportation, and an example of how sound engineering can overcome any problem.
        </p>
        <h2
          class="subtitle"
